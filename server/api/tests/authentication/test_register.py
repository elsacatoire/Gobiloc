...
class RegisterTest(APITestCase):
    ...
    def test_failure_username_already_taken(self):
        ...
        response_data = response.json()
        self.assertIn('username', response_data)
        self.assertIn("A user with that username already exists.", response_data['username'])
    ...
    def test_failure_username_in_password(self):
        ...
        response_data = response.json()
        self.assertIn('password', response_data)
        self.assertIn('The password is too similar to the username.', response_data['password'])
    ...
    def test_failure_email_in_password(self):
        ...
        response_data = response.json()
        self.assertIn('password', response_data)
        self.assertIn('The password is too similar to the email.', response_data['password'])
