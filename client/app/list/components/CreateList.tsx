...
import {
	...
	getCategoryId,
	getCategoryName,
} from "@/app/enums/TodoCategoryEnum";
...
export const CreateList: React.FC = () => {
	...
	const handleIsSharedChange = (event: React.FormEvent<HTMLDivElement>) => {
		const selectedValue = (event.target as HTMLDivElement).getAttribute(
			"data-value",
		);
					...
					<div className="grid gap-4 py-4">
							...
							<Select onValueChange={handleCategoryChange}>
								<SelectTrigger className="w-[230px]">
									<SelectValue
										placeholder={
											category !== null
												? getCategoryName(Number.parseInt(category))
												: "Choisir un type"
										}
									/>
								</SelectTrigger>
						...
						<div className="grid grid-cols-4 items-center gap-4">
							...
							<div className="col-span-3">
								...
								>
									<ToggleGroupItem value="false" data-value="false">
										Perso
									</ToggleGroupItem>
									<ToggleGroupItem value="true" data-value="true">
										Toustes
									</ToggleGroupItem>
								</ToggleGroup>
							</div>
