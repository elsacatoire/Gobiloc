		...
		<>
			<div className="container mx-auto p-4 max-w-2xl">
				...
				<p className="mb-4">
					...
					utilisez l&lsquo;application Gobiloc.
				</p>
				...
				<p className="mb-4">
					...
					adresse email, et mot de passe lorsque vous créez un compte sur
					Gobiloc. Ces données sont nécessaires pour vous offrir les services
					proposés par l&lsquo;application.
				</p>
				...
				<p className="mb-4">
					Les données collectées sont utilisées pour vous permettre de gérer
					votre colocation via Gobiloc, ainsi que pour vous contacter si
					nécessaire. Nous n&lsquo;utilisons pas vos informations personnelles à
					d&lsquo;autres fins sans votre consentement explicite.
				</p>
				...
				<p className="mb-4">
					...
					dans les cas où la loi l&lsquo;exige ou pour protéger nos droits
					légaux.
				</p>
				...
				<p className="mb-4">
					...
					pour protéger vos informations personnelles contre toute perte, accès
				...
				<p className="mb-4">
					...
					avez le droit d&lsquo;accéder, de modifier, de supprimer vos données
				...
				<p className="mb-4">
					...
					sur l&lsquo;application. Vous pouvez configurer votre navigateur pour
					refuser les cookies si vous le souhaitez.
				</p>
				...
				<p className="mb-4">
					...
					cette page, et votre utilisation continue de l&lsquo;application
					signifie que vous acceptez la nouvelle politique.
				</p>

				<p className="mt-8">
					Pour toute question concernant cette politique, veuillez nous
					contacter à<strong> contact@gobiloc.com</strong>.
				</p>
			</div>
		</>
	);
