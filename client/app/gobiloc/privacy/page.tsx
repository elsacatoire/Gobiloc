		...
		<>
			...
			<div className="container mx-auto p-4 max-w-2xl">
				...
				<p className="mb-4">
					...
					nécessaire. Nous n'utilisons pas vos informations personnelles à
					d'autres fins sans votre consentement explicite.
				</p>
				...
				<p className="mb-4">
					...
					sur l'application. Vous pouvez configurer votre navigateur pour
				...
				<p className="mb-4">
					...
					cette page, et votre utilisation continue de l'application signifie
					que vous acceptez la nouvelle politique.
				</p>
